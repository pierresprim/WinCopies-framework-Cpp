...
#define ABSTRACTION_METHODS_RETURN(isConst, returnType, suffix, abstractorPtr, ...) PARSE_ITEMS((isConst, returnType), ABSTRACTION_METHOD_RETURN, (suffix, abstractorPtr), __VA_ARGS__)
