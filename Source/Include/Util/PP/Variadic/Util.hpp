...
#define __GET_LAST_ARG(...) GET_ARG(GET_LAST_ARG_INDEX(__VA_ARGS__), __VA_ARGS__)
#define _GET_LAST_ARG(n, ...) 
#define GET_LAST_ARG(...) _GET_LAST_ARG(COUNT_ARGS(__VA_ARGS__), __VA_ARGS__)
