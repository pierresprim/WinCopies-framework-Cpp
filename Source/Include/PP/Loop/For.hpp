...
#define FOR(n, concatenator, prefix, macro, suffix) _FFOR(CONCATENATE(DECREMENT, n), concatenator, prefix, macro, suffix)IF_TRUE(n, __FOR(n, concatenator, prefix, macro, )suffix)
